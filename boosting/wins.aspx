<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wins.aspx.cs" Inherits="boosting_wins" %>
...
<html lang="en" class="no-js">
    ...
    <head>
        <title> Normal & Ranked Wins - DivisionBoost.eu - League of Legends Elo Boost & Coaching service!</title>
          <meta charset="utf-8"/>
      ...
      <meta property="og:description" content="Normal & Ranked Wins - Elo Boosting - League of Legends" />
      <meta property="og:url" content="https://divisionboost.eu/" />
      <meta property="og:title" content="Normal & Ranked Wins - DivisionBoost" />
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
	<fieldset class="boosting-bg-effect">
        ...
        <!--========== PAGE LAYOUT ==========-->
        <!-- About -->
        <div id="carousel-example-generic1" class="caitlynphoto">
                ...
                <div class="masonry-grid row margin-t-40">
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-md-offset-0" data-scroll-reveal="enter left over 1s and move 300px after 0.5s">
                        ...
                        <h3 style="color:#b5b6ba;">Current Rank</h3>
                            <asp:Image ID="Image8" runat="server" ImageUrl="../img/divisions/bronze-sima-black-white.png" AlternateText="elo boost unranked"/>
					        <asp:DropDownList ID="DropDownList8" runat="server" class="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" OnSelectedIndexChanged="imageallagi4" AutoPostBack="True" Width="160px" ToolTip="Select your League">
							 <asp:ListItem Selected="True" Value="0">Unranked</asp:ListItem>
							 <asp:ListItem Value="1">Normal</asp:ListItem>
							 <asp:ListItem Value="2">Bronze</asp:ListItem>
							 <asp:ListItem Value="3">Silver</asp:ListItem>
							 <asp:ListItem Value="4">Gold</asp:ListItem>
							 <asp:ListItem Value="5">Platinum</asp:ListItem>
							 <asp:ListItem Value="6">Diamond</asp:ListItem>
						  </asp:DropDownList>
						  <asp:DropDownList ID="DropDownList9" runat="server" class="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" OnSelectedIndexChanged="imageallagi4" AutoPostBack="True" Width="160px" AppendDataBoundItems="False" ToolTip="Select your League" Visible="False">
                            ...
                            <div class=" offset-0" data-scrollreveal="enter left">
                                <div class="m20 here" style="text-align: center;">
                                    <div class="col"> 
						                ...
						                <asp:Label ID="placementlb2" runat="server" Text="Win Games" ForeColor="White" Font-Bold="True" Font-Size="22px"></asp:Label>
						                <asp:DropDownList ID="DropDownList10" runat="server" CssClass="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" Width="160px" AutoPostBack="True" OnSelectedIndexChanged="imageallagi4" ToolTip="Select Number of Placement Games">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-md-offset-0" data-scroll-reveal="enter left over 1s and move 300px after 0.5s">
                        <div class=" offset-0" data-scrollreveal="enter left">
                            <div class=" margin-t-40 " style="text-align: center;">
				                ...
				                <asp:Label ID="Label5" runat="server" Text="2.6 Euro" Font-Bold="True" Font-Size="19pt" ForeColor="White"></asp:Label><br />
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-md-offset-0 margin-b-10" data-scroll-reveal="enter left over 1s and move 300px after 0.5s">
                        <div class=" offset-0" data-scrollreveal="enter left">
                            <div class=" margin-t-40 margin-b-50 " style="text-align: center;">
                                <asp:CheckBox ID="CheckBox3" runat="server" text="Duo with Booster" Font-Size="13pt" OnCheckedChanged="CheckBox5_CheckedChanged" AutoPostBack="True" ForeColor="White" />
        ...
        <div id="pricing" style="background-color:#111217;">
                ...
                <div class="content-xs container">
                        ...
                        <div class="col-sm-6 margin-t-50 margin-b-50">
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true" style="color:#10baa8; font-size:25px;"></i><span class="title-description-howwork2"> What is Ranked And Normal Wins Boost?</span><br />
                            <span class="description-howwork2">In Wins Boost games which we provide we guarantee wins games. For example in case your order is 9 games and there are 1 loose our boosters will play more 1 game to reach 9 wins</span>
                        </div>
                    <!--// end row -->
                </div>
                </div>
