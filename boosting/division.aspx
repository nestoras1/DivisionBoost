<%@ Page Language="C#" AutoEventWireup="true" CodeFile="division.aspx.cs" Inherits="boosting_division" %>
...
<html lang="en" class="no-js">
    ...
    <head>
        <title> DivisionBoosting - DivisionBoost.eu - League of Legends Elo Boost & Coaching service!</title>
          <meta charset="utf-8"/>
      ...
      <meta property="og:description" content="Division Boosting - Elo Boosting - League of Legends" />
      <meta property="og:url" content="https://divisionboost.eu/" />
      <meta property="og:title" content="Division Boosting - DivisionBoost" />
 ...
 <asp:UpdatePanel ID="UpdatePanel1" runat="server">
  <ContentTemplate>
	<fieldset class="boosting-bg-effect">
        ...
        <!--========== PAGE LAYOUT ==========-->
        <!-- About -->
        <div id="carousel-example-generic1" class="ahriphoto">
            <div class="content-lg container">
                ...
                <div class="masonry-grid row margin-t-40">
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-md-offset-0" data-scroll-reveal="enter left over 1s and move 300px after 0.5s">
                        ...
                        <h3 style="color:#b5b6ba;">Current Rank</h3>
                            <asp:Image ID="Image2" runat="server" ImageUrl="../img/divisions/silver-sima.png" AlternateText="elo boost silver"/>        
					        <asp:DropDownList ID="DropDownList3" runat="server" CssClass="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" AutoPostBack="True" Width="160px" OnSelectedIndexChanged="imageallagi2" AppendDataBoundItems="False" ToolTip="Select your League" placeholder="Silver">
						        <asp:ListItem Value="1">Bronze</asp:ListItem>
						        <asp:ListItem Selected="True" Value="2">Silver</asp:ListItem>
                            ...
                            <asp:DropDownList ID="DropDownList4" runat="server" CssClass="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" OnSelectedIndexChanged="imageallagi2" AutoPostBack="True" Width="160px" AppendDataBoundItems="False" ToolTip="Select your League" placeholder="V">
						    ...
						    <asp:ListItem Selected="True" Value="5">V</asp:ListItem>
					     </asp:DropDownList>
					     <asp:DropDownList ID="DropDownList5" runat="server" CssClass="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" OnSelectedIndexChanged="imageallagi2" AutoPostBack="True" Width="160px" AppendDataBoundItems="False" ToolTip="Select your League" placeholder="0-20">
						    <asp:ListItem Selected="True" Value="1">0-20</asp:ListItem>
						    <asp:ListItem Value="2">21-40</asp:ListItem>
						    <asp:ListItem Value="3">41-60</asp:ListItem>
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-3 col-md-offset-0" data-scroll-reveal="enter left over 1s and move 300px after 0.5s">
                            <div class=" offset-0" data-scrollreveal="enter left">
                                <div class="m20 here" style="text-align: center;">
                                    <div class="col"> 
                                        <h3 style="color:#b5b6ba;">Desired Rank</h3>
                                        <asp:Image ID="Image3" runat="server" ImageUrl="../img/divisions/bronze-sima.png" AlternateText="elo boost gold" CssClass="image-desired"/>
						                <asp:DropDownList ID="DropDownList6" runat="server" CssClass="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" OnSelectedIndexChanged="imageallagi3" AutoPostBack="True" Width="160px" AppendDataBoundItems="False" ToolTip="Select your League" placeholder="Bronze">
							                <asp:ListItem Selected="True" Value="1">Bronze</asp:ListItem>
							                <asp:ListItem Value="2">Silver</asp:ListItem>
							                <asp:ListItem Value="3">Gold</asp:ListItem>
							                <asp:ListItem Value="4">Platinum</asp:ListItem>
							                <asp:ListItem Value="5">Diamond</asp:ListItem>
							                <asp:ListItem Value="6">Master</asp:ListItem>
						                </asp:DropDownList>
						                <asp:DropDownList ID="DropDownList7" runat="server" CssClass="dropdownstylecss col-xs-offset-1 margin-b-10 center-block" OnSelectedIndexChanged="imageallagi3" AutoPostBack="True" Width="160px" AppendDataBoundItems="False" ToolTip="Select your League" placeholder="Silver">
							                <asp:ListItem Selected="True" Value="1">I</asp:ListItem>
							                <asp:ListItem Value="2">II</asp:ListItem>
							                <asp:ListItem Value="3">III</asp:ListItem>
							                <asp:ListItem Value="4">IV</asp:ListItem>
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-md-offset-0" data-scroll-reveal="enter left over 1s and move 300px after 0.5s">
                        <div class=" offset-0" data-scrollreveal="enter left">
                            <div class=" margin-t-40 " style="text-align: center;">
                                ...
                                <asp:Label ID="Labeldeltext2" runat="server" Text="" Font-Bold="False" Font-Size="19pt" ForeColor="#CC0000" Font-Overline="False" Font-Strikeout="True"></asp:Label><br />
				                <asp:Label ID="Label5" runat="server" Text="Invalid Price" Font-Bold="True" Font-Size="19pt" ForeColor="White"></asp:Label><br />
        ...
        <div id="pricing" style="background-color:#111217;">
                ...
                <div class="content-xs container">
                        ...
                        <div class="col-sm-6 margin-t-50 margin-b-50">
                            ...
                            <i class="fa fa-question-circle" aria-hidden="true" style="color:#10baa8; font-size:25px;"></i><span class="title-description-howwork2"> What is a Division Boost?</span><br />
                            <span class="description-howwork2">A Division Boost is a Type of boost that will guarantee the League and Division you Desire. It will be boosted until your reach the League and Division that you've ordered.</span>
                        </div>
                    <!--// end row -->
                </div>
                </div>
