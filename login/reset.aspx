<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reset.aspx.cs" Inherits="login_reset" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title> Forgot - DivisionBoost.eu - League of Legends Elo Boost & Coaching service!</title>
          <meta charset="utf-8"/>
...
<body>
    ...
    <div class="form">
      <div class="thumbnail"><img src="img/user-icon.png"/></div>
        ...
        <h1 style="color:white;">Reset Account</h1><br />
            <asp:TextBox ID="forgotusertb" CssClass="text1" runat="server" placeholder="Username Or E-mail"></asp:TextBox>
            <asp:Button ID="bt_reset" CssClass="button1" runat="server" Text="Reset" OnClick="bt_reset_Click" />
