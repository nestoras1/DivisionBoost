...
<html lang="en" class="no-js">
    ...
    <head>
        <title> Order Overview - DivisionBoost.eu - League of Legends Elo Boost & Coaching service!</title>
          <meta charset="utf-8"/>
      ...
      <meta property="og:description" content="Dashboard - Elo Boosting - League of Legends" />
      <meta property="og:url" content="https://divisionboost.eu/" />
      <meta property="og:title" content="Dashboard - DivisionBoost" />
                ...
                <div class="masonry-grid row">
                        ...
                        <div class="margin-b-60">
                            <asp:Table ID="Table1" runat="server">
                                <asp:TableRow>
                                    ...
                                    <asp:TableCell>Account Details<asp:Image ID="truefalseimg" runat="server" ImageUrl="img/False_icon.png" Height="20px" Width="20px"/></asp:TableCell>
                                ...
                                <asp:TableRow>
                                    <asp:TableCell><asp:Label ID="Label_orderID2" runat="server" class="userdisplaystats21" Text="Null"></asp:Label></asp:TableCell>
                                    ...
                                    <asp:TableCell><asp:Label ID="Label_server2" runat="server" class="userdisplaystats23" Text="None"></asp:Label></asp:TableCell>
                                    <asp:TableCell><asp:Label ID="Label_summonername2" runat="server" class="userdisplaystats24" Text="Nestor"></asp:Label></asp:TableCell>
                                    <asp:TableCell><asp:Label ID="Label_AccountDetails2" runat="server" class="userdisplaystats25" Text=" Please fill Account, Summoner and Password field " ForeColor="Red"></asp:Label></asp:TableCell>
                                </asp:TableRow>
                            </asp:Table>
                        </div>
                    </div>
                    ...
                    <div class="masonry-grid-item col-xs-12 col-sm-6 col-md-6 sm-margin-t-0 margin-t-30">
                        <div class="margin-b-50">
                            <asp:Button ID="button_saveaccountdetails" runat="server" Text="Save" class="btn-theme btn-theme-sm btn-white-bg text-uppercase" OnClick="button_saveaccountdetails_Click"/>
                    ...
                    <div class="masonry-grid-item col-xs-6 col-sm-6 col-md-6 sm-margin-b-0">
                        <div class="margin-t-20 margin-b-0">
                            <asp:Table ID="Table3" runat="server">
                                ...
                                <asp:TableRow>
                                    <asp:TableCell><asp:Image ID="img_progressdivstart" runat="server" CssClass="col-md-offset-0 col-lg-pull-9"/></asp:TableCell>
                                    <asp:TableCell><asp:Image ID="img_progressdivcurrent" runat="server" /><asp:Label ID="currentplacementlb" runat="server" Text="Label" Visible="False" Font-Size="140px"></asp:Label></asp:TableCell>
                                    <asp:TableCell><asp:Label ID="desiredplacementlb" runat="server" Text="Label" Visible="False" Font-Size="140px"></asp:Label><asp:Image ID="img_progressdivdesired" runat="server" /></asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                                    <asp:TableCell><asp:Label ID="label_progressdivstart" runat="server" Text="Label" Font-Size="22px" Font-Bold="True"></asp:Label></asp:TableCell>
                                    <asp:TableCell><asp:Label ID="label_progressdivcurrent1" runat="server" Text="Label" Font-Size="20px" Font-Bold="True"></asp:Label><asp:Label ID="label_progressdivcurrent2" runat="server" Text="Label" Font-Size="20px" Font-Bold="True"></asp:Label><br /><asp:Label ID="label_progressdivcurrent3" runat="server" Text="Label" Font-Size="20px" Font-Bold="True"></asp:Label></asp:TableCell>
                                    <asp:TableCell><asp:Label ID="label_progressdivdesired" runat="server" Text="Desired Games" Font-Size="20px" Font-Bold="True"></asp:Label></asp:TableCell>
                                </asp:TableRow>
                                <asp:TableRow>
                            ...
                            <div class="div-spacefree">
			                    ...
			                    <div class="chatbox">
				                   <%--<asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>--%>
	                                  <asp:Timer ID="Timer1" OnTick="Timer1_Tick" runat="server" Interval="3500" />
		                                <div id="chatlogs" class="chatlogs">
		                                <asp:UpdatePanel ID="Chatupdatepanel" runat="server" UpdateMode="Conditional" RenderMode="Inline">
		                                <Triggers>
